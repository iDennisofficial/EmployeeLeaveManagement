...
public class LeaveRequestRecyclerViewAdapter extends RecyclerView.Adapter<LeaveRequestRecyclerViewAdapter.ViewHolder> {

    Context context;
    ArrayList<HoDLeaveRequestModel> hoDLeaveRequestModelArrayList;


    public LeaveRequestRecyclerViewAdapter(Context context, ArrayList<HoDLeaveRequestModel> hoDLeaveRequestModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, HoDLeaveRequestDetailActivity.class);
